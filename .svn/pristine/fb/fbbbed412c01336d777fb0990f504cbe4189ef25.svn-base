...
public class infoDetailActivity extends Activity {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        /*
        final float item = intent.getFloatExtra("evalPoint", 0);
        eval_point.setRating(item);*/

        String url = server +"/info/getEvalValue.php";
        eval_point.setRating(item.getEvalValue(url));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        item = (Info)intent.getSerializableExtra("infoDetail");
        ...
        eval_point = (RatingBar)findViewById(R.id.itemEvalPointDetail);
